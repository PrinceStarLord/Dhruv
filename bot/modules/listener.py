...
class MirrorLeechListener:
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name: str, drive_id=None):
        ...
        if self.isLeech:
            ...
            msg += f'\n\n<b>Credits</b>: {self.tag} | <b>Elapsed</b>: {get_readable_time(time() - self.message.date.timestamp())}'
            msg += f"\n\n<b>Upload</b>: {self.mode}"
            ...
            if self.dmMessage:
                ...
                msg += "\n\n<b>Links has been sent in your DM. And in <a href='https://t.me/+mlOT2LHTtTY5MTll'>Mirror Dump.</a></b>"
                sendMessage(msg, self.bot, self.message)
            else:
                if self.message.chat.type != 'private':
                    buttons.sbutton("Save This Message", 'save', 'footer')
